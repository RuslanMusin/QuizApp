...
class EndedTestsFragment : BaseFragment(), EndedTestsView, View.OnClickListener {
    ...
    @Inject
    lateinit var presenterProvider: Provider<EndedTestsPresenter>
    @ProvidePresenter
    fun providePresenter(): EndedTestsPresenter = presenterProvider.get()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initViews()
//        presenter.loadTests(AppHelper.currentUser.id)
    }
...
//            presenter.loadTests(userId)
    ...
    companion object {
        ...
        fun newInstance(): Fragment {
            val fragment = EndedTestsFragment()
            return fragment
        }
    }
}
